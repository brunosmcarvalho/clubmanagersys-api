package com.bcconsulting.clubmanagersys.api.controllers;
...
@RestController
@RequestMapping("/api/cadastrar-socios")
@CrossOrigin(origins = "*")
public class CadastroSocio {

	private static final Logger log = LoggerFactory.getLogger(CadastroSocio.class);
	 ...
	 */
	@PostMapping
	public ResponseEntity<Response<CadastroSDto>> cadastrar(@Valid @RequestBody CadastroPFDto cadastroPFDto,
		...
		Optional<Socio> empresa = this.empresaService.buscarPorCnpj(cadastroPFDto.getCnpj());
